...
const LoginForm = () => {
  const [isSignUp, setIsSignUp] = useState(false);  // State to toggle between sign in/up
  const containerRef = React.useRef(null);  // Ref to refer to the container
  ...
  return (
    <div>
      ...
      <div className="container" id="container" ref={containerRef}>
        <div className={`form-container sign-up-container ${isSignUp ? 'right-panel-active' : ''}`}>
          <form action="#">
